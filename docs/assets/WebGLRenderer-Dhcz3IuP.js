import { S as G, E as d, B as v, w as m, D as S, L as j, v as ve, s as U, t as b, a7 as Be, k as K, a8 as Ae, b as p, V as L, j as B, i as A, l as F, M as $, a9 as z, aa as Ne, ab as ye, ac as Y, ad as Ce, A as Ie, R as De, e as T, __tla as __tla_0 } from "./index-CO0EtiDs.js";
import { b as q } from "./colorToUniform-BXaCBwVl.js";
import { e as Ge, G as Ue, c as Fe, b as Oe, U as Pe, R as Me, B as Z, d as N, f as Le, S as He, a as we, __tla as __tla_1 } from "./SharedSystems-BpBxqyNl.js";
let Ot;
let __tla = Promise.all([
  ...
  var x = ((t) => (t[t.ELEMENT_ARRAY_BUFFER = 34963] = "ELEMENT_ARRAY_BUFFER", t[t.ARRAY_BUFFER = 34962] = "ARRAY_BUFFER", t[t.UNIFORM_BUFFER = 35345] = "UNIFORM_BUFFER", t))(x || {});
  class Ve {
    constructor(e, r) {
    ...
    activateVao(e, r) {
      ...
      for (const o in i) {
        ...
        if (f) {
          ...
          if (((_a = f.format) == null ? void 0 : _a.substring(1, 4)) === "int" ? s.vertexAttribIPointer(l, E.size, M, c.stride, c.offset) : s.vertexAttribPointer(l, E.size, M, E.normalised, c.stride, c.offset), c.instance) if (this.hasInstance) {
  ...
  const je = new Be({
    ...
    init(e = {}) {
      ...
      this.useBackBuffer = r, this._antialias = s, this._renderer.context.supports.msaa || (m("antialiasing, is not supported on when using the back buffer"), this._antialias = false), this._state = G.for2d();
      const n = new ve({
        vertex: `
    ...
    _resizeColor(e, r) {
      ...
      if (r.width = s.pixelWidth, r.height = s.pixelHeight, e.colorTextures.forEach((n, i) => {
        ...
        i.bindFramebuffer(i.FRAMEBUFFER, a), e.colorTextures.forEach((o, c) => {
          ...
          i.bindRenderbuffer(i.RENDERBUFFER, l), i.renderbufferStorageMultisample(i.RENDERBUFFER, 4, f, u.pixelWidth, u.pixelHeight), i.framebufferRenderbuffer(i.FRAMEBUFFER, i.COLOR_ATTACHMENT0 + c, i.RENDERBUFFER, l);
        });
      }
    }
    _initStencil(e) {
...
`));
  ...
  const ht = 0, ft = 1, lt = 2, dt = 3, mt = 4, Et = 5, me = class D {
    constructor(e) {
  ...
  class St {
    constructor(e) {
      this.target = te.TEXTURE_2D, this.texture = e, this.width = -1, this.height = -1, this.type = h.UNSIGNED_BYTE, this.internalFormat = I.RGBA, this.format = I.RGBA, this.samplerType = 0;
    }
  }
  const pt = {
    id: "buffer",
  ...
  class be {
    ...
    contextChange(e) {
      this._gl = e, this._mapFormatToInternalFormat || (this._mapFormatToInternalFormat = At(e, this._renderer.context.extensions), this._mapFormatToType = Nt(e), this._mapFormatToFormat = Bt(e)), this._glTextures = /* @__PURE__ */ Object.create(null), this._glSamplers = /* @__PURE__ */ Object.create(null), this._boundSamplers = /* @__PURE__ */ Object.create(null), this._premultiplyAlpha = false;
  ...
  class Se {
    ...
    execute(e, r) {
      ...
      for (let _ = 0; _ < c.instructionSize; _++) {
        const f = u[_];
        if (f.size) {
          for (let l = 0; l < f.textures.count; l++) i.texture.bind(f.textures.textures[l], l);
