import { T as M, U as Z, P as m, r as te, E as y, a as ie, w as g, e as P, C as V, __tla as __tla_0 } from "./index-CO0EtiDs.js";
import { __tla as __tla_1 } from "./webworkerAll-BLf256pq.js";
...
Promise.all([
  ...
  class q {
    ...
    destroy() {
      this._observer ? (this._observer.disconnect(), this._observer = null) : this._tickerAttached && M.shared.remove(this.updateTranslation), this._domElement = null, this._renderer = null, this._canvas = null, this._tickerAttached = false, this._lastTransform = "", this._lastScaleX = null, this._lastScaleY = null;
    }
  }
  class w {
    constructor(e) {
      this.bubbles = true, this.cancelBubble = true, this.cancelable = false, this.composed = false, this.defaultPrevented = false, this.eventPhase = w.prototype.NONE, this.propagationStopped = false, this.propagationImmediatelyStopped = false, this.layer = new m(), this.page = new m(), this.NONE = 0, this.CAPTURING_PHASE = 1, this.AT_TARGET = 2, this.BUBBLING_PHASE = 3, this.manager = e;
    }
    get layerX() {
      return this.layer.x;
    }
  ...
  const se = G.default ?? G, oe = se(globalThis.navigator), re = 9, W = 100, ae = 0, le = 0, j = 2, z = 1, he = -1e3, ce = -1e3, de = 2, L = class J {
    constructor(e, t = oe) {
      this._mobileInfo = t, this.debug = false, this._activateOnTab = true, this._deactivateOnMouseMove = true, this._isActive = false, this._isMobileAccessibility = false, this._div = null, this._pools = {}, this._renderId = 0, this._children = [], this._androidUpdateCount = 0, this._androidUpdateFrequency = 500, this._isRunningTests = false, this._boundOnKeyDown = this._onKeyDown.bind(this), this._boundOnMouseMove = this._onMouseMove.bind(this), this._hookDiv = null, (t.tablet || t.phone) && this._createTouchHook(), this._renderer = e;
    }
    get isActive() {
    ...
    _activate() {
      ...
      this._isActive = true, this._div || (this._div = document.createElement("div"), this._div.style.position = "absolute", this._div.style.top = `${ae}px`, this._div.style.left = `${le}px`, this._div.style.pointerEvents = "none", this._div.style.zIndex = j.toString(), this._canvasObserver = new q({
        domElement: this._div,
        renderer: this._renderer
      })), this._activateOnTab && globalThis.addEventListener("keydown", this._boundOnKeyDown, false), this._deactivateOnMouseMove && globalThis.document.addEventListener("mousemove", this._boundOnMouseMove, true);
    ...
    _deactivate() {
      if (!(!this._isActive || this._isMobileAccessibility)) {
        this._isActive = false, globalThis.document.removeEventListener("mousemove", this._boundOnMouseMove, true), this._activateOnTab && globalThis.addEventListener("keydown", this._boundOnKeyDown, false), this._renderer.runners.postrender.remove(this);
        ...
        for (const e in this._pools) this._pools[e].forEach((i) => {
    ...
    postrender() {
      ...
      for (let i = this._children.length - 1; i >= 0; i--) {
        ...
        t.has(i) || (n._accessibleDiv && n._accessibleDiv.parentNode && (n._accessibleDiv.parentNode.removeChild(n._accessibleDiv), this._getPool(n.accessibleType).push(n._accessibleDiv), n._accessibleDiv = null), n._accessibleActive = false, te(this._children, i, 1));
      }
    ...
    destroy() {
      var _a;
      this._deactivate(), this._destroyTouchHook(), (_a = this._canvasObserver) == null ? void 0 : _a.destroy(), this._canvasObserver = null, this._div = null, this._pools = null, this._children = null, this._renderer = null, this._hookDiv = null, globalThis.removeEventListener("keydown", this._boundOnKeyDown), this._boundOnKeyDown = null, globalThis.document.removeEventListener("mousemove", this._boundOnMouseMove, true), this._boundOnMouseMove = null;
    }
  ...
  class Q {
    ...
    postrender() {
      ...
      for (let t = 0; t < e.length; t++) {
        ...
        if (!i.parent || i.globalDisplayStatus < 7) n == null ? void 0 : n.remove(), e.splice(t, 1), t--;
        else {
    ...
    destroy() {
      ...
      for (let e = 0; e < this._attachedDomElements.length; e++) (_a = this._attachedDomElements[e].element) == null ? void 0 : _a.remove();
  ...
  class ve {
    ...
    addTickerListener() {
      this._tickerAdded || !this.domElement || (M.system.add(this._tickerUpdate, this, Z.INTERACTION), this._tickerAdded = true);
    }
    removeTickerListener() {
      this._tickerAdded && (M.system.remove(this._tickerUpdate, this), this._tickerAdded = false);
    }
    pointerMoved() {
      this._didMove = true;
    }
    ...
    destroy() {
      this.removeTickerListener(), this.events = null, this.domElement = null, this._deltaTime = 0, this._didMove = false, this._tickerAdded = false, this._pauseUpdate = true;
    }
  }
  const f = new ve();
  class A extends w {
  ...
  class _e {
    constructor(e) {
      this.dispatch = new ie(), this.moveOnAll = false, this.enableGlobalMoveEvents = true, this.mappingState = {
        trackingData: {}
    ...
    hitTestMoveRecursive(e, t, i, n, s, o = false) {
      ...
      if ((e.eventMode === "dynamic" || t === "dynamic") && (f.pauseUpdate = false), e.interactiveChildren && e.children) {
        const h = e.children;
        for (let _ = h.length - 1; _ >= 0; _--) {
          const c = h[_], p = this.hitTestMoveRecursive(c, this._isInteractive(t) ? t : c.eventMode, i, n, s, o || s(e, i));
          if (p) {
    ...
    hitTestRecursive(e, t, i, n, s) {
      ...
      if ((e.eventMode === "dynamic" || t === "dynamic") && (f.pauseUpdate = false), e.interactiveChildren && e.children) {
        ...
        for (let h = l.length - 1; h >= 0; h--) {
          const _ = l[h], c = this.hitTestRecursive(_, this._isInteractive(t) ? t : _.eventMode, d, n, s);
          if (c) {
  ...
  const ge = 1, ye = {
    ...
    constructor(e) {
      this.supportsTouchEvents = "ontouchstart" in globalThis, this.supportsPointerEvents = !!globalThis.PointerEvent, this.domElement = null, this.resolution = 1, this.renderer = e, this.rootBoundary = new _e(null), f.init(this), this.autoPreventDefault = true, this._eventsAdded = false, this._rootPointerEvent = new u(null), this._rootWheelEvent = new E(null), this.cursorStyles = {
        default: "inherit",
        pointer: "pointer"
