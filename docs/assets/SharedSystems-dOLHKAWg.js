...
`;
  ...
  const z = class he {
    constructor(e, t) {
      var _a, _b;
      this.state = Le.for2d(), this._batchersByInstructionSet = /* @__PURE__ */ Object.create(null), this._activeBatches = /* @__PURE__ */ Object.create(null), this.renderer = e, this._adaptor = t, (_b = (_a = this._adaptor).init) == null ? void 0 : _b.call(_a, this);
    }
    static getBatcher(e) {
    ...
    buildEnd(e) {
      ...
      for (const r in t) {
        ...
        n.indexBuffer.setDataWithSize(s.indexBuffer, s.indexSize, true), n.buffers[0].setDataWithSize(s.attributeBuffer.float32View, s.attributeSize, false);
      }
    }
    upload(e) {
      ...
      for (const r in t) {
        const s = t[r], n = s.geometry;
        s.dirty && (s.dirty = false, n.buffers[0].update(s.attributeSize * 4));
      }
    }
    execute(e) {
  ...
  class pe {
    ...
    push(e, t, r) {
      ...
      if (s.renderPipes.batch.break(r), r.add({
        ...
        const n = e.mask;
        n.includeInBuild = true, n.collectRenderables(r, s, null), n.includeInBuild = false;
      }
    ...
    execute(e) {
      ...
      if (e.action === "pushMaskBegin") {
        ...
        if (s.inverse = e.inverse, r) {
          e.mask.mask.measurable = true;
          const n = He(e.mask.mask, true, st);
          e.mask.mask.measurable = false, n.ceil();
          const i = t.renderTarget.renderTarget.colorTexture.source, o = b.getOptimalTexture(n.width, n.height, i._resolution, i.antialias);
          t.renderTarget.push(o, true), t.globalUniforms.push({
            offset: n,
  ...
  class ve {
    ...
    push(e, t, r) {
      ...
      const o = n.mask;
      o.includeInBuild = true, this._maskHash.has(n) || this._maskHash.set(n, {
        instructionsStart: 0,
        instructionsLength: 0
      });
      const l = this._maskHash.get(n);
      l.instructionsStart = r.instructionSize, o.collectRenderables(r, i, null), o.includeInBuild = false, i.renderPipes.batch.break(r), r.add({
        renderPipeId: "stencilMask",
        action: "pushMaskEnd",
        mask: e,
        inverse: t._maskOptions.inverse,
    ...
    pop(e, t, r) {
      ...
      for (let o = 0; o < i.instructionsLength; o++) r.instructions[r.instructionSize++] = r.instructions[i.instructionsStart++];
      r.add({
        renderPipeId: "stencilMask",
        action: "popMaskEnd",
        canBundle: false
  ...
  Gt = class {
    ...
    _systemCheck() {
      if (!We()) throw new Error("Current environment does not allow unsafe-eval, please use pixi.js/unsafe-eval module to enable support.");
    }
    ...
    syncUniformGroup(e, t, r) {
      ...
      let n = null;
      return t || (t = e.buffer.data, n = e.buffer.dataInt32), r || (r = 0), s.syncFunction(e.uniforms, t, n, r), true;
    }
    updateUniformGroup(e) {
      if (e.isStatic && !e._dirtyId) return false;
      e._dirtyId = 0;
  ...
  It = function(a, e, t, r) {
    ...
    for (let o = 0; o < a.length; o++) {
      ...
      let c = false, h = 0;
      for (let p = 0; p < C.length; p++) if (C[p].test(l.data)) {
        h = l.offset / 4, s.push(`name = "${d}";`, `offset += ${h - n};`, C[p][e] || C[p].ubo), c = true;
        break;
      }
      if (!c) if (l.data.size > 1) h = l.offset / 4, s.push(t(l, h - n));
      else {
...
`);
  ...
  const xe = class _e {
    constructor(e = {}) {
      if (this.uid = M("renderTarget"), this.colorTextures = [], this.dirtyId = 0, this.isRoot = false, this._size = new Float32Array(2), this._managedColorTextures = false, e = {
        ..._e.defaultOptions,
        ...e
      }, this.stencil = e.stencil, this.depth = e.depth, this.isRoot = e.isRoot, typeof e.colorTextures == "number") {
        this._managedColorTextures = true;
        for (let t = 0; t < e.colorTextures; t++) this.colorTextures.push(new T({
          width: e.width,
          height: e.height,
        ...
        this.colorTextures = [
          ...e.colorTextures.map((r) => r.source)
        ];
    ...
    onSourceResize(e) {
      this.resize(e.width, e.height, e._resolution, true);
    }
    ...
    resize(e, t, r = this.resolution, s = false) {
  ...
  Dt = class {
    constructor(e) {
      this.rootViewPort = new w(), this.viewport = new w(), this.onRenderTargetChange = new Ne("onRenderTargetChange"), this.projectionMatrix = new v(), this.defaultClearColor = [
        0,
        0,
        0,
        0
      ], this._renderSurfaceToRenderTargetHash = /* @__PURE__ */ new Map(), this._gpuRenderTargetHash = /* @__PURE__ */ Object.create(null), this._renderTargetStack = [], this._renderer = e, e.renderableGC.addManagedHash(this, "_gpuRenderTargetHash");
    }
    finishRenderPass() {
    ...
    renderStart({ target: e, clear: t, clearColor: r, frame: s }) {
      var _a, _b;
      this._renderTargetStack.length = 0, this.push(e, t, r, s), this.rootViewPort.copyFrom(this.viewport), this.rootRenderTarget = this.renderTarget, this.renderingToScreen = lt(this.rootRenderTarget), (_b = (_a = this.adaptor).prerender) == null ? void 0 : _b.call(_a, this.rootRenderTarget);
    }
    postrender() {
      var _a, _b;
    ...
    bind(e, t = true, r, s) {
      ...
      return ot(this.projectionMatrix, 0, 0, d.width / l.resolution, d.height / l.resolution, !n.isRoot), this.adaptor.startRenderPass(n, t, r, d), i && this.onRenderTargetChange.emit(n), n;
    }
    clear(e, t = B.ALL, r) {
      t && (e && (e = this.getRenderTarget(e)), this.adaptor.clear(e || this.renderTarget, t, r, this.viewport));
    }
    contextChange() {
    ...
    pop() {
      ...
      this.bind(e.renderTarget, false, null, e.frame);
    }
    getRenderTarget(e) {
    ...
    _initRenderTarget(e) {
      let t = null;
      return U.test(e) && (e = ge(e).source), e instanceof G ? t = e : e instanceof T && (t = new G({
        colorTextures: [
          e
        ]
      }), e.source instanceof U && (t.isRoot = true), e.once("destroy", () => {
  ...
  Ot = class extends je {
    constructor({ buffer: e, offset: t, size: r }) {
      super(), this.uid = M("buffer"), this._resourceType = "bufferResource", this._touched = 0, this._resourceId = M("resource"), this._bufferResource = true, this.destroyed = false, this.buffer = e, this.offset = t | 0, this.size = r, this.buffer.on("change", this.onBufferChange, this);
    }
    onBufferChange() {
      this._resourceId = M("resource"), this.emit("change", this);
    }
    destroy(e = false) {
      this.destroyed = true, e && this.buffer.destroy(), this.emit("change", this), this.buffer = null;
    }
  };
  class be {
    constructor(e) {
  ...
  class Te {
    ...
    _executeCacheAsTexture(e) {
      if (e.textureNeedsUpdate) {
        e.textureNeedsUpdate = false;
        const t = ut.identity().translate(-e._textureBounds.x, -e._textureBounds.y);
        this._renderer.renderTarget.push(e.texture, true, null, e.texture.frame), this._renderer.globalUniforms.push({
  ...
  function ye(a, e = false) {
    ...
    if (e) for (let s = 0; s < a.renderGroupChildren.length; s++) ye(a.renderGroupChildren[s], e);
  }
  function ct(a) {
    const e = a.root;
    let t;
    if (a.renderGroupParent) {
      ...
      a.worldTransform.appendFrom(e.relativeGroupTransform, r.worldTransform), a.worldColor = oe(e.groupColor, r.worldColor), t = e.groupAlpha * r.worldAlpha;
  ...
  function ke(a, e, t) {
    ...
    a.updateTick = e, a.didChange = false;
    const r = a.localTransform;
    a.updateLocalTransform();
    const s = a.parent;
    if (s && !s.renderGroup ? (t |= a._updateFlags, a.relativeGroupTransform.appendFrom(r, s.relativeGroupTransform), t & te && re(a, s, t)) : (t = a._updateFlags, a.relativeGroupTransform.copyFrom(r), t & te && re(a, dt, t)), !a.renderGroup) {
      const n = a.children, i = n.length;
      for (let d = 0; d < i; d++) ke(n[d], e, t);
  ...
  function re(a, e, t) {
    if (t & ue) {
      a.groupColor = oe(a.localColor, e.groupColor);
  ...
  class Ce {
    ...
    _updateCachedRenderGroups(e, t) {
      ...
      for (let r = e.renderGroupChildren.length - 1; r >= 0; r--) this._updateCachedRenderGroups(e.renderGroupChildren[r], t);
      if (e.invalidateMatrices(), e.isCachedAsTexture) {
        if (e.textureNeedsUpdate) {
          const r = e.root.getLocalBounds();
          r.ceil();
          const s = e.texture;
          e.texture && b.returnTexture(e.texture, true);
          const n = this._renderer, i = e.textureOptions.resolution || n.view.resolution, o = e.textureOptions.antialias ?? n.view.antialias, l = e.textureOptions.scaleMode ?? "linear", d = b.getOptimalTexture(r.width, r.height, i, o);
          d._source.style = new $e({
            scaleMode: l
          }), e.texture = d, e._textureBounds || (e._textureBounds = new O()), e._textureBounds.copyFrom(r), s !== e.texture && e.renderGroupParent && (e.renderGroupParent.structureDidChange = true);
        }
      } else e.texture && (b.returnTexture(e.texture, true), e.texture = null);
    }
    _updateRenderGroups(e) {
      const t = this._renderer, r = t.renderPipes;
      if (e.runOnRender(t), e.instructionSet.renderPipes = r, e.structureDidChange ? E(e.childrenRenderablesToUpdate.list, 0) : ht(e, r), ye(e), e.structureDidChange ? (e.structureDidChange = false, this._buildInstructions(e, t)) : this._updateRenderables(e), e.childrenRenderablesToUpdate.index = 0, t.renderPipes.batch.upload(e.instructionSet), !(e.isCachedAsTexture && !e.textureNeedsUpdate)) for (let s = 0; s < e.renderGroupChildren.length; s++) this._updateRenderGroups(e.renderGroupChildren[s]);
    }
  ...
  const W = class Se {
    constructor() {
      this.clearBeforeRender = true, this._backgroundColor = new A(0), this.color = this._backgroundColor, this.alpha = 1;
    }
    init(e) {
      e = {
        ...Se.defaultOptions,
    ...
    set color(e) {
      A.shared.setValue(e).alpha < 1 && this._backgroundColor.alpha === 1 && L("Cannot set a transparent background on an opaque canvas. To enable transparency, set backgroundAlpha < 1 when initializing your Application."), this._backgroundColor.setValue(e);
    }
    get alpha() {
  ...
  class we {
    constructor(e) {
      this._blendModeStack = [], this._isAdvanced = false, this._filterHash = /* @__PURE__ */ Object.create(null), this._renderer = e, this._renderer.runners.prerender.add(this);
    }
    prerender() {
    ...
    setBlendMode(e, t, r) {
      ...
      if (this._activeBlendMode === t) {
        this._isAdvanced && e && !s && ((_a = this._renderableList) == null ? void 0 : _a.push(e));
        return;
      }
    ...
    _ensureFilterEffect(e) {
      ...
      return t || (t = this._filterHash[e] = new ie(), t.filters = [
        new y[e]()
      ]), t;
    }
    _endAdvancedBlendMode(e) {
      this._isAdvanced = false, this._renderableList = null, this._renderer.renderPipes.batch.break(e), e.add({
        renderPipeId: "filter",
        action: "popFilter",
        canBundle: false
      });
  ...
  const R = {
    ...
    async base64(e) {
      e = this._normalizeOptions(e, Pe.defaultImageOptions);
      const { format: t, quality: r } = e, s = this.canvas(e);
      if (s.toBlob !== void 0) return new Promise((n, i) => {
        s.toBlob((o) => {
          if (!o) {
  ...
  class Re {
    ...
    generateTexture(e) {
      ...
      const i = ((_a = e.frame) == null ? void 0 : _a.copyTo(vt)) || qe(s, gt).rectangle;
  ...
  class Be {
    ...
    bind({ size: e, projectionMatrix: t, worldTransformMatrix: r, worldColor: s, offset: n }) {
      ...
      const c = d.uniforms;
      c.uProjectionMatrix = l.projectionMatrix, c.uResolution = l.resolution, c.uWorldTransformMatrix.copyFrom(l.worldTransformMatrix), c.uWorldTransformMatrix.tx -= l.offset.x, c.uWorldTransformMatrix.ty -= l.offset.y, Ze(l.worldColor, c.uWorldColorAlpha, 0), d.update();
      let h;
      this._renderer.renderPipes.uniformBatch ? h = this._renderer.renderPipes.uniformBatch.getUniformBindGroup(d, false) : (h = this._bindGroupPool.pop() || new Ye(), this._activeBindGroups.push(h), h.setResource(d, 0)), l.bindGroup = h, this._currentGlobalUniformData = l;
    }
    push(e) {
...
`,
  ...
  const $ = class Ae {
    ...
    set enabled(e) {
      this.enabled !== e && (e ? (this._handler = this._renderer.scheduler.repeat(() => this.run(), this._frequency, false), this._hashHandler = this._renderer.scheduler.repeat(() => {
        for (const t of this._managedHashes) t.context[t.hash] = Tt(t.context[t.hash]);
      }, this._frequency), this._arrayHandler = this._renderer.scheduler.repeat(() => {
        for (const t of this._managedArrays) yt(t.context[t.hash]);
    ...
    run() {
      ...
      for (let n = 0; n < t.length; n++) {
        ...
        const o = i.renderGroup ?? i.parentRenderGroup, l = ((_a = o == null ? void 0 : o.instructionSet) == null ? void 0 : _a.gcTick) ?? -1;
        if (((o == null ? void 0 : o.gcTick) ?? 0) === l && (i._lastUsed = e), e - i._lastUsed > this.maxUnusedTime) {
          if (!i.destroyed) {
            const d = r;
            o && (o.structureDidChange = true), d[i.renderPipeId].destroyRenderable(i);
          }
  ...
  const K = class Ie {
    ...
    init(e) {
      e = {
        ...Ie.defaultOptions,
        ...e
      }, e.view && (Je(Xe, "ViewSystem.view has been renamed to ViewSystem.canvas"), e.canvas = e.view), this.screen = new w(0, 0, e.width, e.height), this.canvas = e.canvas || H.get().createCanvas(), this.antialias = !!e.antialias, this.texture = ge(this.canvas, e), this.renderTarget = new G({
        colorTextures: [
          this.texture
        ],
        depth: !!e.depth,
    ...
    destroy(e = false) {
      (typeof e == "boolean" ? e : !!(e == null ? void 0 : e.removeView)) && this.canvas.parentNode && this.canvas.parentNode.removeChild(this.canvas), this.texture.destroy();
    }
  };
  K.extension = {
    type: [
