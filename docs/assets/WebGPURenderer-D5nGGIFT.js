import { S as E, g as L, E as p, f as ae, D as B, b as C, B as T, c as ue, d as A, h as M, w as v, i as x, j as ce, k as de, l as k, m as w, M as D, n as H, o as he, p as pe, q as z, s as F, t as R, A as le, R as fe, e as S, __tla as __tla_0 } from "./index-BSJj79Mi.js";
import { l as ge, a as me } from "./colorToUniform-BXaCBwVl.js";
import { c as _e, u as be, U as xe, B as ye, G as Ge, e as Be, R as Se, t as Pe, S as Te, a as Ce, __tla as __tla_1 } from "./SharedSystems-BNdaFFQp.js";
let qe;
let __tla = Promise.all([
  ...
  class O {
    start(e, t, r) {
      ...
      this._shader = r, this._geometry = t, i.setGeometry(t, n), y.blendMode = "normal", s.pipeline.getPipeline(t, n, y);
    ...
    execute(e, t) {
      ...
      const n = s.bindGroup.getBindGroup(t.bindGroup, r, 1), o = s.pipeline.getPipeline(this._geometry, r, y, t.topology);
  ...
  class N {
    ...
    setGeometry(e, t) {
      ...
      for (const s in r) this._setVertexBuffer(parseInt(s, 10), e.attributes[r[s]].buffer);
    ...
    draw(e) {
      ...
      this.setPipelineFromGeometryProgramAndState(t, r.gpuProgram, s, i), this.setGeometry(t, r.gpuProgram), this._setShaderBindGroups(r, c), t.indexBuffer ? this.renderPassEncoder.drawIndexed(n || t.indexBuffer.data.length, u ?? t.instanceCount, o || 0) : this.renderPassEncoder.draw(n || t.getSize(), u ?? t.instanceCount, o || 0);
    }
    finishRenderPass() {
      this.renderPassEncoder && (this.renderPassEncoder.end(), this.renderPassEncoder = null);
    }
    ...
    restoreRenderPass() {
      const e = this._renderer.renderTarget.adaptor.getDescriptor(this._renderer.renderTarget.renderTarget, false, [
        0,
        0,
        0,
        1
      ...
      const t = this._boundPipeline, r = {
        ...this._boundVertexBuffer
      }, s = this._boundIndexBuffer, i = {
  ...
  function Ue(a) {
    ...
    for (let r = 0; r < e.length; r++) {
      ...
      if (!G[s.data.type]) throw new Error(`[Pixi.js] WebGPU UniformBuffer: Unknown type ${s.data.type}`);
  ...
  class Y {
    constructor(e) {
      this._bindGroupHash = /* @__PURE__ */ Object.create(null), this._buffers = [], this._bindGroups = [], this._bufferResources = [], this._renderer = e, this._renderer.renderableGC.addManagedHash(this, "_bindGroupHash"), this._batchBuffer = new ve({
    ...
    destroy() {
      var _a;
      for (let e = 0; e < this._bindGroups.length; e++) (_a = this._bindGroups[e]) == null ? void 0 : _a.destroy();
  ...
  class $ {
    ...
    getBufferNamesToBind(e, t) {
      ...
      for (let o = 0; o < s.length; o++) {
        ...
        for (const l in n) if (n[l].location === c) {
          i[o] = l;
          break;
        }
      }
    ...
    _updatePipeHash() {
      const e = Le(this._stencilMode, this._multisampleCount, this._colorMask, this._depthStencilAttachment);
  ...
  class ke {
    ...
    copyToTexture(e, t, r, s, i) {
      const n = this._renderer, o = this._getGpuColorTexture(e), u = n.texture.getGpuSource(t.source);
    ...
    getDescriptor(e, t, r) {
      ...
      const s = this._renderTargetSystem, i = s.getGpuRenderTarget(e), n = e.colorTextures.map((c, l) => {
        const h = i.contexts[l];
        let f, d;
        h ? f = h.getCurrentTexture().createView() : f = this._renderer.texture.getGpuSource(c).createView({
          mipLevelCount: 1
        }), i.msaaTextures[l] && (d = f, f = this._renderer.texture.getTextureView(i.msaaTextures[l]));
    ...
    initGpuRenderTarget(e) {
      ...
      return e.colorTextures.forEach((r, s) => {
        if (r instanceof ce) {
          const i = r.resource.getContext("webgpu"), n = r.transparent ? "premultiplied" : "opaque";
          try {
            i.configure({
    ...
    resizeGpuRenderTarget(e) {
      ...
      t.width = e.width, t.height = e.height, t.msaa && e.colorTextures.forEach((r, s) => {
        var _a;
        (_a = t.msaaTextures[s]) == null ? void 0 : _a.resize(r.source.width, r.source.height, r.source._resolution);
      });
    }
  }
  class X extends Se {
  ...
  class Z {
    ...
    _createGPUProgramData(e) {
      const t = this._gpu.device, r = e.gpuLayout.map((i) => t.createBindGroupLayout({
        entries: i
      })), s = {
        bindGroupLayouts: r
      };
  ...
  class J {
    constructor() {
      this.defaultState = new E(), this.defaultState.blend = true;
    }
    contextChange(e) {
      this.gpu = e;
    }
  ...
  class Oe {
    ...
    generateMipmap(e) {
      ...
      if (!i) {
        ...
        for (let c = 1; c < e.mipLevelCount; ++c) n.copyTextureToTexture({
          texture: r,
          mipLevel: c - 1
        }, {
          texture: e,
  ...
  class te {
    ...
    destroy() {
      ...
      for (const e of Object.keys(this._bindGroupHash)) {
        const t = Number(e);
        (_a = this._bindGroupHash[t]) == null ? void 0 : _a.destroy(), this._bindGroupHash[t] = null;
      }
  ...
  class re {
    ...
    execute(e, t) {
      const r = t.context, s = r.customShader || this.shader, i = e.renderer, n = i.graphicsContext, { batcher: o, instructions: u } = n.getContextRenderData(r), c = i.encoder;
      c.setGeometry(o.geometry, s.gpuProgram);
      const l = i.globalUniforms.bindGroup;
      c.setBindGroup(0, l, s.gpuProgram);
      const h = i.renderPipes.uniformBatch.getUniformBindGroup(s.resources.localUniforms, true);
      ...
      for (let _ = 0; _ < u.instructionSize; _++) {
        ...
        if (m.topology !== d && (d = m.topology, c.setPipelineFromGeometryProgramAndState(o.geometry, s.gpuProgram, e.state, m.topology)), s.groups[1] = m.bindGroup, !m.gpuBindGroup) {
          const P = m.textures;
          m.bindGroup = L(P.textures, P.count, this._maxTextures), m.gpuBindGroup = i.bindGroup.getBindGroup(m.bindGroup, s.gpuProgram, 1);
        }
